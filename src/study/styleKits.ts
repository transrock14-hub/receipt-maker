...
export const RECEIPT_STYLE_KITS: ReceiptStyleKit[] = [
  ...
  },
  {
    ...
    notes: [
      'Soft teal→black wash (not rings)',
      'RM initials for 3-part names',
      'Frosted circular nav · → outbound badge',
      'Muted Transfer completed title',
      'Full From + Confirmation footer',
    ],
    layout: { topInset: 40, rowDensity: 'tight', darkChrome: true },
  },
  {
    id: 'kit-wise',
    brand: 'Wise',
