...
export const RECEIPT_STYLE_KITS: ReceiptStyleKit[] = [
  ...
  },
  {
    ...
    notes: [
      'Teal header wash → black',
      'Initials avatar + outbound badge',
      'Send again / Schedule / Split bill',
      'Equivalent + Reference cards',
      'Green transfer timeline + Share',
      'From Personal · EUR + Download',
    ],
    layout: { topInset: 48, rowDensity: 'tight', darkChrome: true },
  },
  {
    id: 'kit-wise',
    brand: 'Wise',
